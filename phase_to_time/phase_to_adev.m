...
fF=  [1    10  100 1000 10000 1e5] %
SdBc(:,1)=[-70  -70  -95  -120 -130 -130]; % BC/GM class I
SdBc(:,2)=[-100 -100 -115 -130 -140 -140]; % GM class II (LJ)
SdBc(:,3)=[-90  -90  -107 -125 -135 -135]  % BC class II

...
\begin{frame}[fragile]\frametitle{LiteX implementation on CLE215+ \& M2SDR: {\footnotesize\url{https://github.com/enjoy-digital/litex_wr_nic}}}
...
\includegraphics[width=1.56\linewidth]{figures/2025-06-16-203322_2704x1050_scrot.png}
...
\begin{minipage}[t]{\linewidth}
\begin{minipage}{.49\linewidth}
\only<1>{\includegraphics[width=\linewidth]{allan_wr_acorn_new.png}
